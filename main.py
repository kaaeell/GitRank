    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if repos_response.status_code == 200:
                ...
                if repos:
                    ...
                    if languages_used:
                        ...
                        # NEW: Number of languages

                        print(
                            f"   Number of languages: "
                            f"{len(languages_used)}"
                        )
            ...
            if data['followers'] > data['following']:
                ...
                print(
                    "👥 This user has more followers "
                    "than people they follow."
                )

            elif data['followers'] < data['following']:

                print(
                    "👥 This user follows more people "
                    "than follow them."
                )
                ...
                print(
                    "👥 Followers and following are equal."
                )

            if data['public_repos'] >= 20:

                print(
                    "💻 They have a large public portfolio."
                )

            elif data['public_repos'] > 0:
            ...
            if completeness == 100:
                ...
                print(
                    "📝 Their profile is fairly minimal."
                )
            ...
            print(
                "⚠️ GitHub's servers might be having issues."
            )
